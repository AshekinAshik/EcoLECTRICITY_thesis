...
const GetCitizens = () => {
    ...
    const [searchedCitizenData, setSearchedCitizenData] = useState()
        ...
        <>
            ...
            <div className="min-h-fit">
                <body>
                    <center>
                        <br></br> <br></br>
                        <h4 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-4xl dark:text-white"> All Available <mark class="px-2 text-white bg-green-400 rounded dark:bg-blue-500">Citizens</mark> List </h4>
                        <br></br>
