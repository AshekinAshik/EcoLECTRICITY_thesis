                    ...
                    <div className="body-topnbottom">
                        <center>
                            ...
                            {is_Energy_vs_Cost_Hidden ? null : (
                                <div className="graph-container-customer-daily-energycost">
                                    <div className="graph-content">
                                        <Chart options={OptionsChartLine} series={SeriesChartLine_Energy_vs_Cost} type="area" height={410} width={1000} />
                                    </div>
                                </div>
                            )}
                            ...
                            {is_Cost_Hidden ? null : (
                                <div className="graph-container-customer-daily-energycost">
                                    <div className="graph-content">
                                        <Chart options={OptionsChartLine} series={SeriesChartLine_Cost} type="area" height={410} width={1000} />
                                    </div>
                                </div>
                            )}
                            ...
                            {is_Energy_Hidden ? null : (
                                <div className="graph-container-customer-daily-energycost">
                                    <div className="graph-content">
                                        <Chart options={OptionsChartLine} series={SeriesChartLine_Energy} type="area" height={410} width={1000} />
                                    </div>
                                </div>
                            )}
                            <br></br>
